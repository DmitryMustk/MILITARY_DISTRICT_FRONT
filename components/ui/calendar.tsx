    ...
    <DayPicker
      ...
      classNames={{
        ...
        day_button: cn(
          ...
          'disabled:bg-inherit disabled:text-black disabled:opacity-50 size-8 p-0 font-normal transition-none hover:bg-transparent hover:text-inherit aria-selected:opacity-100'
        ),
        ...
        hidden: 'invisible',
        dropdowns: 'h-full flex justify-center items-center gap-[0.5rem]',
        dropdown_root: 'h-full relative',
        dropdown: 'z-2 opacity-0 appearance-none absolute start-0 end-0 w-full m-0 p-0 border-none',
        ...classNames,
      }}
      components={{
        Chevron: ({ orientation }) => {
          if (orientation === 'down') {
            return <ChevronDownIcon size={18} strokeWidth={1} className="inline-block" />;
          }
